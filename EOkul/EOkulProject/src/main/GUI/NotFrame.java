 ...
 * @author Ebubekir
 */
public class NotFrame extends javax.swing.JFrame {

    String oNo;

    /**
     * Creates new form NotFrame
     */
    public NotFrame() {
        initComponents();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnlistele, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE))
                .addGap(36, 36, 36))
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(34, 34, 34)
                        .addComponent(btnlistele, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnlisteleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlisteleActionPerformed
        String txt="";
        try {
            FileInputStream fin = new FileInputStream(oNo+"-notlar.txt");
            int i = 0;
            while ((i = fin.read()) != -1) {
                txt+=(char)i;
            }
        ...
        String[] notlar=txt.split("!");
        String[] notnew=new String[notlar.length];
        for(int i=0;i<notlar.length;i++){
            notnew[i]=notlar[i].replace(";", " ");
            notlar[i]=notnew[i];
            notnew[i]=notlar[i].replace(",", " ");
        }
        for(String i : notlar){
        ...
        this.jList1.setListData(notnew);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
